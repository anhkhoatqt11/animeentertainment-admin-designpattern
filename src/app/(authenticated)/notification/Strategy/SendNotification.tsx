...
import { notificationStrategies } from "./content_notification_strategy";
...
export default function SendNotification() {
  ...
  const currentStrategy = notificationStrategies[selected];
  ...
  const onSendNotification = async () => {
    ...
    const data = currentStrategy.prepareNotificationData(itemChoice[0], value);
  ...
  const NotificationList = currentStrategy.ListComponent;
